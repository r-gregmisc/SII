...
1. **New Users**: This configuration provides a warm, comfortable profile. It uses a soft gain multiplier ($\mu = 0.40$) and minimizes low-frequency penalties ($C_{vals} = [-3, 2, 3, 0, -2, -2, -2, -2]$).
2. **Experienced Users**: This configuration provides a balanced approach. It uses a moderate gain multiplier ($\mu = 0.45$) alongside standard loudness constraints ($C_{vals} = [-8, -1, 3, 1, 0, 0, 0, 0]$).
3. **Power Users**: This configuration maximizes spectral sharpness to prioritize SII efficiency. It uses a high gain multiplier ($\mu = 0.50$) while retaining the standard low-frequency penalty array ($C_{vals} = [-8, -1, 3, 1, 0, 0, 0, 0]$).
...
### H. Conductive component correction
...
Chen, Z., Hu, G., & Glasberg, B. R. (2011). "Derivation of the parameters of a loudness model for normal and hearing-impaired listeners," The Journal of the Acoustical Society of America 129(4), 2106-2117.

Johnson, E. E. (2013). "Conductive hearing loss and NAL-NL2: A rationale for 75% compensation," The Hearing Journal 66(4), 16-20.

Johnson, E. E., and Dillon, H. (2011). "A comparison of NAL-NL2 and DSL m[i/o] v5.0a for adults," The Hearing Journal 64(10), 30-36.

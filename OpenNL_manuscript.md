...
![Bland-Altman Agreement Analysis](manuscript_figures/Figure5_BlandAltman.png)
...
![Final Insertion Gain Targets for 50, 65, and 80 dB SPL Inputs across standard audiometric profiles, illustrating Open-NL's multi-level constraint-based optimization relative to NAL-NL2 (Severe-loss booster set to Aggressive mode for profiles A4 and A5).](manuscript_figures/OpenNL_vs_NALNL2_Gain_Final.png){width=100%}

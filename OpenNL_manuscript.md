...
Despite these fundamentally distinct approaches, the models exhibited robust approximate convergence: a mean bias of $+0.23$ sones, a Mean Absolute Error (MAE) of $0.39$ sones, and 95% Limits of Agreement from $-0.71$ to $+1.17$ sones (**Figure 2**). Notably, when restricted to the 1–10 sone band, agreement tightens substantially, yielding a mean bias of $+0.08$ sones and an MAE of $0.12$ sones. Restricting the post hoc error analysis to this specific band is analytically justified because all clinical speech prescriptive targets (50-80 dB SPL) uniquely occupy this physiological envelope; massive discrepancies above 10 sones merely reflect divergent algorithmic handling of traumatic $>90$ dB SPL inputs that are categorically excluded from target formulae.

![Bland-Altman Agreement Analysis](figures/Figure2_BlandAltman.png)
*Figure 2. Bland-Altman difference plot between Open-NL's stationary spectral C++ engine and AMT's dynamic time-domain simulation (`bramslow2004`) across 45 evaluation points. The solid blue line indicates mean bias (+0.23 sones), and dashed red lines indicate 95% Limits of Agreement [-0.71, +1.17].*
...
|  | Open-NL | 10.5 | 25.0 | 33.4 | 33.0 | 32.7 | 6.5 |
| A7 | NAL-NL2 | 34.7 | 34.6 | 34.7 | 34.8 | 35.0 | 35.1 |
|  | Open-NL | 5.9 | 18.4 | 23.3 | 22.4 | 19.6 | 2.6 |

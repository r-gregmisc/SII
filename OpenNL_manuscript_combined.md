...
![Parameter Sensitivity Analysis](figures/Figure4_Sensitivity.png)
...
![Bland-Altman Agreement Analysis](figures/Figure5_BlandAltman.png)
*Figure 5. Bland-Altman plot demonstrating near-exact computational agreement between the native Open-NL C++ engine and the external Auditory Modeling Toolbox (AMT) across 45 canonical evaluation points (Profiles A1–A5).*
...
![Comparison of ANSI SII (Raw Physical Audibility) vs Desensitized SII for NAL-NL2 and Open-NL across 50, 65, and 80 dB SPL Inputs.](figures/OpenNL_vs_NALNL2_SII_Grouped.png){width=100%}

![Final Insertion Gain Targets for 50, 65, and 80 dB SPL Inputs across standard audiometric profiles, illustrating Open-NL's multi-level constraint-based optimization relative to NAL-NL2 (Severe-loss booster set to Aggressive mode for profiles A4 and A5).](figures/OpenNL_vs_NALNL2_Gain_Final.png){width=100%}

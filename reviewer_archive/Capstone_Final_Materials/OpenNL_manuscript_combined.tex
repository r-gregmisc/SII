...
(\(\text{SD} < 0.025\) SII) for any fixed parameter set. Crucially, by
...
A5 (Severe), illustrating the robustness of the constrained optimization
space against heuristic parameter modifications.}

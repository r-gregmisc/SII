...
(\(\text{SD} < 0.025\) SII) for any fixed parameter set. Crucially, a
...
exceptionally tight: just \(\sigma = 0.02\) sones for A4 and
\(\sigma = 0.05\) sones for A5.
...
requires waveform-level biophysical models: - HASPI (Hearing Aid Speech

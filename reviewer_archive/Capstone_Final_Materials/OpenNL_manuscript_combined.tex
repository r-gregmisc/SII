...
& \(L_{cap}\) vectors (Section S.I.12) & Derived from normal/impaired
physiological loudness growth models. \\
& Optimizer Penalty Weights (\(\lambda_{1-8}\)) &
\(\lambda_1=450, \dots, \lambda_8=20\) (Sec S.I.12) & Pragmatic
engineering constraints balancing target convergence. \\
...
Profile
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Median Desensitized SII {[}Min, Max{]}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
\textbf{A1} & Mild & 15 & 20 & 30 & 40 & 50 & 60 & 0 dB \\
\textbf{A2} & Reverse slope & 60 & 50 & 40 & 30 & 20 & 15 & 0 dB \\
\textbf{A3} & Moderately sloping & 10 & 20 & 40 & 50 & 55 & 60 & 0 dB \\
\textbf{A4} & Severe & 0 & 0 & 10 & 40 & 70 & 80 & 0 dB \\
\textbf{A5} & Profound & 10 & 10 & 20 & 60 & 80 & 100 & 0 dB \\
...
soft-compression envelope (\(L_{gain}\)):
...
by minimizing an soft-constrained multi-objective loss function via
...
where \(\text{SII}_{desens}\) is the desensitized Speech Intelligibility

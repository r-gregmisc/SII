...
# Remove any stale global copies that would shadow the freshly-loaded package functions
suppressWarnings(rm(list = intersect(c("open_nl", "sii", "calculate_loudness", "calculate_loudness_cpp"), ls(envir = .GlobalEnv)), envir = .GlobalEnv))

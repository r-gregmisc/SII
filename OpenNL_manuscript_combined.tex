...
was near-exact: Bland-Altman analysis revealed a mean bias of \(+0.23\)
sones, with tight 95\% limits of agreement
\([-0.71, +1.17   ext{ sones}]\) and a Mean Absolute Error (MAE) of just
\(0.39\) sones. This negligible translation error confirms high
